...
export default graphql(CreateRecipe, {
  props: props => ({ // This object is passed to the component as props
    onAdd: recipe => props.mutate({ // Add recipe handler
      variables: recipe,
      optimisticResponse: { // Optimistic!
        __typename: 'Mutation',
        createRecipe: { ...recipe, __typename: 'Recipe' }
      },
      update: (proxy, { data: { createRecipe } }) => { // Refresh the cache
